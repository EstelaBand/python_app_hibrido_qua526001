...
def main(page: ft.Page):
    ...
    gasolina = ft.TextField(
        ...
        prefix_text="R$ ",
        keyboard_type=ft.KeyboardType.NUMBER # Abre o teclado apenas numérico
    )
    etanol = ft.TextField(
    ...
    page.add(
        ...
        ft.ResponsiveRow( #ele serve para adaptar para qualquer aplicativo em qualquer tela (mobile)
            [
